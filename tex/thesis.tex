...
with a focus on simplicity and readibility. The generic core algorithm is ~400loc of Python, and to use it in a specific problem requires about ~70 
...
\section{Methodology}
    ...
    \subsection{Implementation details}
        ...
        (like a name of environment in gymnasium, or a offset for calculating fitness) it is stored in the meta field. This implementation was chosen
...
\begin{itemize}
    \item XOR   
    The xor problem was tested with a population of 50, 100 tries and generation threshold of 300. The solution was found in 87 trials, and mean
    generations it took to find the solution was 120.5, with standard deviation of 63.6 generations.
    \item Acrobot 
    \item Cartpole
    The xor problem was tested with a population of 50 and generation threshold of 300. The results are presented in the table below.
\end{itemize}
