...
is 
For disjoint and excess genes, the algorithm chooses randomly from which parent to inherit the gene. For matching genes, the algorithm chooses randomly
 and then for each gene chooses randomly one of the two genomes to inherit the gene from.
